...
/**
 * 根据bow相似度提取候选闭环帧，然后匹配、优化一系列操作，判断是否闭环
 * 过程略复杂
*/
...
/**
 * 提取候选匹配帧的共视帧集合，以及二级共视帧集合，作为一个大map，在当前帧中寻找2d匹配点，返回匹配点数量，超过阈值认为闭环
*/
